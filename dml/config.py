...
arg_lists = []
parser = argparse.ArgumentParser(description='deep_mutual_learning')
...
data_arg.add_argument('--num_classes', type=int, default=6,
...
train_arg.add_argument('--lr_patience', type=int, default=100,
...
misc_arg.add_argument('--data_dir', type=str, default='./data/fold1',
                      help='Directory in which data is stored')
misc_arg.add_argument('--ckpt_dir', type=str, default='./dml/5cv_ckpt/dml_50',
                      help='Directory in which to save model checkpoints')
misc_arg.add_argument('--logs_dir', type=str, default='./dml/log/dml_50',
...
misc_arg.add_argument('--save_name', type=str, default='fold5',
